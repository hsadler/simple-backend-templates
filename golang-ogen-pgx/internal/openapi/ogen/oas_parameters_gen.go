...
// GetAllItemsParams is parameters of getAllItems operation.
...
func unpackGetAllItemsParams(packed middleware.Parameters) (params GetAllItemsParams) {
	{
...
func decodeGetAllItemsParams(args [0]string, argsEscaped bool, r *http.Request) (params GetAllItemsParams, _ error) {
...
// GetItemsParams is parameters of getItems operation.
type GetItemsParams struct {
	// Item IDs.
	ItemIds []int
}

func unpackGetItemsParams(packed middleware.Parameters) (params GetItemsParams) {
	{
		key := middleware.ParameterKey{
			Name: "item_ids",
			In:   "query",
...
func decodeGetItemsParams(args [0]string, argsEscaped bool, r *http.Request) (params GetItemsParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
